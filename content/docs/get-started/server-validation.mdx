...
> **This call must always happen on your server — never in the browser.** It requires your Secret Key (`sk_...`).
...
```js
const response = await fetch("https://ycaptcha.xyspg.moe/api/v0/captcha/siteverify", {
  method: "POST",
