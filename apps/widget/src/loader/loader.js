(() => {
  var ORIGIN = (() => {
    ...
    return __YCAPTCHA_WIDGET_URL__;
  })();
  ...
  // Handle onload callback and render mode (e.g. ?onload=myCallback&render=explicit)
  var script = document.currentScript;
  var renderMode = "implicit";
  if (script?.src) {
    var url = new URL(script.src);
    renderMode = url.searchParams.get("render") || "implicit";
  ...
  // Auto-render unless render=explicit
  if (renderMode !== "explicit") {
    if (
